...
class Autentifikasi extends CI_Controller {
    public function index() {
        ...
        $this->form_validation->set_rules('email', 'Alamat Email', 'required|min_length[3]|valid_email', [
        ...
        $this->form_validation->set_rules('password', 'Password', 'required|trim', [
            'required' => 'Password Diisi Dong!'
        ]);

        if ($this->form_validation->run() == false) {
            $data['judul'] = 'Login';
            $data['user'] = '';
            // Kata 'login' merupakan nilai dari variabel judul dalam array $data dikirimkan ke view auth/header
